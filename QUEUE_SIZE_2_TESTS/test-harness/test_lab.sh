...
mkdir /home/u3/kgc0019/COMP3510/projects/lab3/QUEUE_SIZE_2_TESTS/TEST_RESULTS
RESULT_PATH=/home/u3/kgc0019/COMP3510/projects/lab3/QUEUE_SIZE_2_TESTS/TEST_RESULTS
cd /home/u3/kgc0019/COMP3510/projects/lab3/code/
cc -o lab3 lab3.c devices3.o -lm -DTWO_QUEUE
for DEVICE in "${DEVS[@]}"
do
	for MU in "${MUs[@]}"
	do
